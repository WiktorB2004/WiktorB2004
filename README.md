...
| C | <ul><li>[Language Interpreter (WLang)](https://github.com/WiktorB2004/Language_Interpreter-C) - My own language interpreter in C</li></ul> |
| JavaScript / TS | <ul><li>[Shops API](https://github.com/WiktorB2004/JSON_Transformer-JS) - Project to get experience with NestJS</li></ul> |
